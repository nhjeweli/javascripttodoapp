...
async function go() {
  let client = new MongoClient("mongodb+srv://mainUser:Godvnt1F6Hkq9TIl@cluster0.pkiwxll.mongodb.net/TodoApp?retryWrites=true&w=majority")
...
function passwordProtected(req, res, next) {
  ...
  if (req.headers.authorization == "Basic bGVhcm46amF2YXNjcmlwdHM=") {
    next()
  } else {
